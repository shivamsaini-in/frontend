...
export function CTASection() {
  return (
    <section className="relative py-28 px-6 overflow-hidden bg-[#0D0D0F]">
      {/* Glow */}
      ...
      <div className="relative max-w-3xl mx-auto text-center">
        ...
        >
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <Link
              href="/login"
              className="group flex items-center gap-2.5 px-8 py-4 rounded-2xl bg-primary text-white font-bold text-sm glow-primary hover:bg-primary/90 transition-all duration-200 text-base"
            >
              Get Started Free
            ...
            <Link
              href="/login"
              className="px-8 py-4 rounded-2xl border border-white/15 bg-white/5 text-white/70 font-semibold text-sm hover:bg-white/10 hover:text-white transition-all duration-200 text-base"
            >
              Sign In →
            </Link>
          </div>
